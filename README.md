...
- `2026-07-24/` contains the released Class 16 Text Structure and Purpose learning handout. Answers and annotations remain controlled separately through the private Teacher Dashboard.
